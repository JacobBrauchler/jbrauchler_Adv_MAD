...
public class MainActivity extends Activity implements ActivitiesListFragment.ActivityListListener, ActivitiesDetailFragment.ButtonClickListener {
    ...
    @Override public void itemClicked(long id){
        ...
        if (fragmentContainer != null) {
            ...
            ActivitiesDetailFragment frag = new ActivitiesDetailFragment();
